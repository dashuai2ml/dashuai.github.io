...
<template>
  <div class="flex flex-col items-center">
    ...
    <div class="flex flex-col rounded-md mb-3 justify-center sm:p-10 p-5 sm:w-[700px] w-[300px] sm:h-[100px] bg-white hover:drop-shadow-md transition-all duration-300">
      ...
      <p class="text-gray-500">Tailwind CSS 通过基于类的样式定义和实用程序性样式的组合，大大简化了样式管理的过程，在开发速度、可维护性和可扩展性方面成为现代前端开发的新趋势。</p>
    </div>
    <div class="flex flex-col rounded-md mb-3 justify-center sm:p-10 p-5 sm:w-[700px] w-[300px] sm:h-[100px] bg-white hover:drop-shadow-md transition-all duration-300">
      <a href="https://dashuai2ml.notion.site/71f9448765614e61b894081d656f3317" target="_blank"><p class=" font-bold">对人类文明进程的思考</p></a>
      <p class="text-gray-500">通过分析人类社会的技术进步、科学发现和文化变革，文章呈现了人类文明进程中的关键转折点和里程碑。</p>
    </div>
